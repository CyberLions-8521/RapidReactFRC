...
public final class Constants {
    ...
    public static class CAN {
        ...
        public static final int kLeftMiddleSlave = 1; 
        // Entirely Right Side Gear Box
        public static final int kRightSlave = 6;
        public static final int kRightMiddleSlave = 2; 
        // Rest of the Subsystems...
        public static final int kIntake = 7; 
        public static final int kIndexorLower = 8;
        public static final int kIndexorFront = 9; 
        public static final int kIndexorBack = 10; 
        public static final int kShooter = 11; 
        public static final int kElevator = 12; 
